...
var SilkError = function (_Error) {
  _inherits(SilkError, _Error);

  function SilkError() {
    _classCallCheck(this, SilkError);

    return _possibleConstructorReturn(this, (SilkError.__proto__ || Object.getPrototypeOf(SilkError)).apply(this, arguments));
  }
...
var Actor = function (_SilkObject) {
  ...
  function Actor(element) {
    ...
    //World stuff
    var _this2 = _possibleConstructorReturn(this, (Actor.__proto__ || Object.getPrototypeOf(Actor)).call(this, element));
...
var Stage = function (_SilkObject2) {
  ...
  function Stage(element) {
    ...
    var _this3 = _possibleConstructorReturn(this, (Stage.__proto__ || Object.getPrototypeOf(Stage)).call(this, element));

    _this3.actors = [];
    _this3.running = false;

    //Timers for ticks
    _this3.renderTimer = new Timer();
    _this3.updateTimer = new Timer();

    _this3.renderTicks = 0;
    _this3.updateTicks = 0;

    //FPS TESTER
    _this3.fpsTimer = new Timer();
    _this3.fps = 0;
    return _this3;
  }
